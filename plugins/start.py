    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"Maje Kar Beta 24 Hours Ke Liye Ja Dekh Le🥹  \n\nYour token successfully verified and valid for: 24 Hour", reply_markup=reply_markup, protect_content=True, quote=True)
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                full_tut_url = f"https://t.me/teraboxlinksop/9"
